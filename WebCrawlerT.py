...
with pd.ExcelWriter('C:/Users/Kobra/Desktop/TagesschauData.xlsx', mode="a", engine="openpyxl", if_sheet_exists='overlay') as writer:
    df.to_excel(writer, sheet_name='Sheet1', header=False, startrow=writer.sheets['Sheet1'].max_row, index=False)



dfData = pd.read_excel('C:/Users/Kobra/Desktop/TagesschauData.xlsx')
dfData = dfData.drop_duplicates(subset=['Headline'])
dfData.to_excel('C:/Users/Kobra/Desktop/TagesschauData.xlsx', index=False)
